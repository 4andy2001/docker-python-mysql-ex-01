...
Create repository in github 4andy2001 called docker-python-mysql-ex-01
Get the URL of the repository, i.e., git@github.com:4andy2001/docker-python-mysql-ex-01.git

Create a .gitignore file

In the directory containing the project files, i.e., docker-python-mysql-ex-01 execute the following to initialize the git project do the initial commit and push: 
```
git init
git add .
git commit   
git remote add origin git@github.com:4andy2001/docker-python-mysql-ex-01.git
git branch -M main
